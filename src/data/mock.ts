...
export const videoIntelReports: VideoIntelReport[] = [
  // --- vr1: MMA Machine Controller Display ---
  {
    ...
    ocrFields: [
      ...
      { id: 'ocr-fill-time', label: 'Fill Injection Time', value: '0.51s', confidence: 0.93, frameTimestamp: 2.1, frameUrl: '/images/clean-mma-screen.png', bbox: { x: 0.46, y: 0.068, w: 0.14, h: 0.03 } },
      { id: 'ocr-plast-time', label: 'Plasticizing Time', value: '14.37s', confidence: 0.91, frameTimestamp: 2.1, frameUrl: '/images/clean-mma-screen.png', bbox: { x: 0.62, y: 0.068, w: 0.14, h: 0.03 } },
    ],
    detectedObjects: [
      { id: 'obj-display', label: 'Machine Controller Display', count: 1, confidence: 0.98, frameTimestamp: 2.0, frameUrl: '/images/clean-mma-screen.png', details: 'Nissei SI-200-6S H450E Φ46, Controller No. 62, Monitor Data screen', bbox: { x: 0.02, y: 0.01, w: 0.90, h: 0.95 } },
      { id: 'obj-data-table', label: 'Shot Data Table', count: 1, confidence: 0.94, frameTimestamp: 5.0, frameUrl: '/images/clean-mma-screen.png', details: '227 shots logged, columns: Cycle Time, Injection Time, Pack Press, Cushion Position, Plast. Time, Heater Temp', bbox: { x: 0.03, y: 0.10, w: 0.87, h: 0.72 } },
    ],
  },
